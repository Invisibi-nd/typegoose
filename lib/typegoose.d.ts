 ...
 * ```
 */
export declare function buildSchema<U extends AnyParamConstructor<any>>(cl: U, options?: mongoose.SchemaOptions, originalOptions?: IModelOptions): mongoose.Schema<DocumentType<U>>;
/**

 ...
 * ```
 */
export declare type DocumentType<T> = (T extends {
    _id: unknown;
} ? mongoose.Document<T['_id']> & T : mongoose.Document & T) & IObjectWithTypegooseFunction;
/**
 * Used Internally for ModelTypes
 */
export declare type ModelType<T, QueryHelpers = BeAnObject> = mongoose.Model<DocumentType<T>, QueryHelpers>;
/**

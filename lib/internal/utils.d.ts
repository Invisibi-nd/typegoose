...
export declare function initProperty(name: string, key: string, whatis: WhatIsIt): {
    [path: string]: Function[] | typeof mongoose.SchemaType | mongoose.SchemaTypeOptions<any> | mongoose.Schema<mongoose.Document<any, {}>, mongoose.Model<any, any>, undefined> | any | mongoose.Schema<mongoose.Document<any, {}>, mongoose.Model<any, any>, undefined>[] | mongoose.SchemaTypeOptions<any>[] | any[];
};
/**
